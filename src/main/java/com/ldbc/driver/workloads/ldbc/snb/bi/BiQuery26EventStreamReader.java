...
public class BiQuery26EventStreamReader extends BaseEventStreamReader
{
    public BiQuery26EventStreamReader(
    ...
    {
        return new LdbcSnbBiQuery26PersonsPerCountryInContinent(
                (String) parameters[0]
        );
    }
